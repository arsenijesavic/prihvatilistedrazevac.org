module.exports = {
  ...
  en: {
    page: {
      adopt: {
        headline: `Kod nas uvek možeš pronaći svog novog drugara, a ako slučajno ne možeš, pronaći će on tebe!`,
        faq: [
          {
            index: 0,
            question: "Da li su sve životinje u prihvatilištu socijalizovane?",
          ...
          {
            index: 1,
            question: "Ako udomim psa koji nije više štene, da li ću moći da ga disciplinujem?",
          ...
          {
            index: 3,
            question: "Šta ako već imam psa/mačku, hoće li se slagati s novom životinjom?",
          ...
          {
            index: 5,
            question: "Koliko vremena treba da se mačka adaptira na novog vlasnika?",
          ...
          {
            index: 6,
            question: "Da li je okej da uzmem psa i da bude na lancu ili kavezu?",
      ...
      donate: {
        headline: "Svaka pomoć je dobrodošla",
        subheadline: `Mesečni troškovi prihvatilišta su jako veliki s obzirom na broj životinja koje hranimo, lečimo i izdržavamo. Svaka donacija, velika ili mala, mesečna ili jednokratna je ono što održava prihvatilište i naših 300 njuški.`,
      },
      visit: {
